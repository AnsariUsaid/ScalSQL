          ...
          <form onSubmit={handleTestConnection} className="space-y-6 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input type="text" required className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Production Analytics RDS" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-textMuted">Database Type</label>
                <select className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all appearance-none cursor-pointer">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 space-y-2">
                ...
                <input type="text" required className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="db-prod.cluster-[id].us-east-1.rds.amazonaws.com" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-textMuted">Port</label>
                <input type="number" required className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="5432" defaultValue="5432" />
              </div>
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-textMuted">Database Name</label>
              <input type="text" required className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="healthcare_records" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-medium text-textMuted">Username</label>
                <input type="text" required className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="readonly_analyst" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-textMuted">Password (Encrypted at Rest)</label>
                <input type="password" required className="block w-full px-4 py-3 border border-border rounded-xl bg-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all font-mono" placeholder="••••••••••••" />
              </div>
            </div>
        ...
        >
          <div className="glass-panel p-6 rounded-2xl">
             <h3 className="font-bold flex items-center justify-between mb-4 text-lg">
               Active Connections
               <span className="px-2 py-0.5 bg-primary/20 text-primary text-xs rounded-full">1</span>
             </h3>

             <div className="p-4 rounded-xl border border-primary bg-primary/5 cursor-pointer hover:bg-primary/10 transition-colors">
               ...
               <div className="text-xs text-textMuted font-mono bg-surface p-2 rounded border border-border mt-3 line-clamp-1">
                 db-sales.cluster-xy...amazonaws.com
               </div>
               <div className="flex justify-between items-center mt-4">
                 <span className="text-xs text-textMuted">PostgreSQL • 12 Tables</span>
